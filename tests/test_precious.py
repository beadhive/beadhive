...
def test_scanner_git_seam_scrubs_ambient_git_context(monkeypatch) -> None:
    captured = {}
    ...
    monkeypatch.setattr(precious.subprocess, "run", fake_run)

    precious._run_git(["git", "status"], capture=True)
