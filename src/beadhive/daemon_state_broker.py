...
from .kernel.lifecycle import (
    HostDaemonRuntimePort as DaemonRuntimePort,
)
...
class DaemonStateBroker:
    ...
    def for_host(
        ...
        *,
        ...
        default_client_queue_bytes: int = 1024 * 1024,
    ) -> DaemonStateBroker:
        ...
        return cls(
            ...
            default_client_queue_bytes=default_client_queue_bytes,
        )
