...
from . import daemon_local_state as _daemon_local_state
...
from .kernel.lifecycle import (
    HostDaemonLifespanComponent as LifespanComponent,
)
from .kernel.lifecycle import (
    HostDaemonShutdownPhase as ShutdownPhase,
)
from .kernel.lifecycle import (
    HostDaemonStartupPhase as StartupPhase,
)
...
_daemon_local_state.configure_compatibility_facade(
    key_factory=lambda: DaemonKey.current(),
    status_reader=lambda key: daemon_status(key),
)
...
def build_product_application(
    *,
    ...
    state_broker = state_broker_factory(
        runtime=runtime,
        host_id=host_id,
        cfg=cfg,
        settings=settings,
        relay_factory=OperatorEventRelay,
    )
