...
class _LegacyHostDaemonConfig(_DaemonSection):
    ...
    @model_validator(mode="after")
    def _secure_exposure(self) -> _LegacyHostDaemonConfig:
...
# The modular configuration contract is authoritative.  This legacy module retains listener
# material validation below and forwards the public model identity for existing callers.
from .kernel.daemon.contracts.config import HostDaemonConfig as HostDaemonConfig  # noqa: E402
