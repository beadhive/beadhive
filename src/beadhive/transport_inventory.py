...
_OPERATOR_APPLICATION_PROJECTIONS: dict[tuple[str, str], dict[str, Any]] = {
    ...
    ("GET", "/api/v1/hives/{hive_id}/snapshot-with-work-items"): {
        ...
        "composes": ("work.list", "work.schedule"),
        "shape": "coarser",
        "reason": "remote-safe state seed with revision-pinned work-item retrieval capability",
    },
    ...
    ("GET", "/api/v1/hives/{hive_id}/work-item-pages"): {
        ...
        "operation": "work.list",
        "shape": "richer",
        "reason": "bounded remote-safe summary projection of the canonical work list read",
    },
    ("GET", "/api/v1/hives/{hive_id}/work-item-details/{bead_id}"): {
        "classification": "catalog-entry",
        "operation": "work.issue",
        "shape": "richer",
        "reason": "bounded remote-safe exact projection of the canonical work issue read",
    },
...
def _gateway_projections() -> tuple[ProjectionSpec, ...]:
    ...
    functional = (
        ...
        _gateway(
            ...
            operation="work.list",
            wire_family="gateway.read.v1",
            wire_request_schema="workItemsRequest",
            wire_result_schema="canonicalWorkItemsResponse",
            reason="bounded revision-pinned factory-qualified work-item page",
            shape="richer",
        ),
        _gateway(
            "GET",
            ...
            operation="work.show",
            wire_family="gateway.read.v1",
            wire_request_schema="workItemDetailRequest",
            wire_result_schema="canonicalWorkItemDetailResponse",
            reason="bounded factory-qualified exact work-item detail",
            shape="richer",
        ),
        _gateway(
            "GET",
        ...
        _gateway(
            ...
            wire_family="gateway.read.v1",
            wire_request_schema="workItemsRequest",
            wire_result_schema="workItemsResponse",
            reason="bounded revision-pinned work-item page",
            shape="richer",
        ),
        _gateway(
            "GET",
            ...
            wire_family="gateway.read.v1",
            wire_request_schema="workItemDetailRequest",
            wire_result_schema="workItemDetailResponse",
            reason="bounded exact work-item detail",
            shape="richer",
        ),
        _gateway(
            "GET",
