...
check: lint lint-md license-check wire-schema-compat test
...
check-all: require-bd lint lint-md license-check wire-schema-compat (test FAST) test-integration-land demo-local-loop demo-live-ingress
