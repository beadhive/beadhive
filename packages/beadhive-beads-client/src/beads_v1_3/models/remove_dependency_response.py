...
class RemoveDependencyResponse:
    """
    Attributes:
        removed (bool): True when an edge was there and is now gone. FALSE IS A SUCCESS, not a refusal: it says this
            pair carried no such edge, which is the same graph a second removal leaves. Nothing was written for it.
    """
