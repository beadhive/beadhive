...
if TYPE_CHECKING:
    ...
    from ..models.issue_with_dependency_metadata_metadata import IssueWithDependencyMetadataMetadata


T = TypeVar("T", bound="IssueWithDependencyMetadata")


@_attrs_define
class IssueWithDependencyMetadata:
    """A full issue plus the type of the dependency edge that led to it. Property semantics are documented on `Issue`.
    ...
    Attributes:
        ...
        dependency_type (str): The edge type, e.g. `blocks`, `parent-child`, `related`, `discovered-from`. Not a closed
            vocabulary.
        ...
        metadata (IssueWithDependencyMetadataMetadata | Unset):
    ...
    metadata: IssueWithDependencyMetadataMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.issue_with_dependency_metadata_metadata import (
            IssueWithDependencyMetadataMetadata,  # noqa: PLC0415
        )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = IssueWithDependencyMetadataMetadata.from_dict(_metadata)
        ...
        issue_with_dependency_metadata = cls(
            id=id,
            title=title,
            priority=priority,
            created_at=created_at,
        ...
        issue_with_dependency_metadata.additional_properties = d
        return issue_with_dependency_metadata
